...
ios_test_filters_raw="${IOS_TEST_FILTERS:-MRTTests/PreferencesTests MRTTests/SettingsValidationTests MRTTests/ChatViewModelTests MRTTests/ConnectionManagerTests MRTTests/SessionViewModelTests MRTTests/GitViewModelTests MRTTests/FilesViewModelTests}"
...
read -r -a ios_test_filters <<< "${ios_test_filters_raw}"
test_args=()
for filter in "${ios_test_filters[@]}"; do
